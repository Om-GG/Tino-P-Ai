(globalThis["webpackChunkconsuming_external_apis"] = globalThis["webpackChunkconsuming_external_apis"] || []).push([["vendors-node_modules_langchain_dist_chat_models_openai_js"],{
...
/* harmony import */ var _memory_base_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../memory/base.js */ "./node_modules/langchain/dist/memory/base.js");
...
class BaseChatModel extends _base_language_index_js__WEBPACK_IMPORTED_MODULE_1__.BaseLanguageModel {
    ...
    async generate(messages, stop) {
        const generations = [];
        const llmOutputs = [];
        const messageStrings = messages.map((messageList) => (0,_memory_base_js__WEBPACK_IMPORTED_MODULE_2__.getBufferString)(messageList));
...
/* harmony import */ var _util_axios_fetch_adapter_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../util/axios-fetch-adapter.js */ "./node_modules/langchain/dist/util/axios-fetch-adapter.js");
/* harmony import */ var _base_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./base.js */ "./node_modules/langchain/dist/chat_models/base.js");
/* harmony import */ var _schema_index_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../schema/index.js */ "./node_modules/langchain/dist/schema/index.js");
/* harmony import */ var _base_language_count_tokens_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../base_language/count_tokens.js */ "./node_modules/langchain/dist/base_language/count_tokens.js");
...
function openAIResponseToChatMessage(role, text) {
    switch (role) {
        case "user":
            return new _schema_index_js__WEBPACK_IMPORTED_MODULE_3__.HumanChatMessage(text);
        case "assistant":
            return new _schema_index_js__WEBPACK_IMPORTED_MODULE_3__.AIChatMessage(text);
        case "system":
            return new _schema_index_js__WEBPACK_IMPORTED_MODULE_3__.SystemChatMessage(text);
        default:
            return new _schema_index_js__WEBPACK_IMPORTED_MODULE_3__.ChatMessage(text, role ?? "unknown");
    }
}
/**
 ...
 */
class ChatOpenAI extends _base_js__WEBPACK_IMPORTED_MODULE_2__.BaseChatModel {
    ...
    async getNumTokensFromMessages(messages) {
        ...
        if ((0,_base_language_count_tokens_js__WEBPACK_IMPORTED_MODULE_4__.getModelNameForTiktoken)(this.modelName) === "gpt-3.5-turbo") {
            tokensPerMessage = 4;
            tokensPerName = -1;
        }
        else if ((0,_base_language_count_tokens_js__WEBPACK_IMPORTED_MODULE_4__.getModelNameForTiktoken)(this.modelName).startsWith("gpt-4")) {
            tokensPerMessage = 3;
            tokensPerName = 1;
        }
        ...
        if (!this.client) {
            const clientConfig = new openai__WEBPACK_IMPORTED_MODULE_0__.Configuration({
                ...
                baseOptions: {
                    ...
                    adapter: _util_axios_fetch_adapter_js__WEBPACK_IMPORTED_MODULE_1__["default"],
...
/* harmony import */ var _event_source_parse_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./event-source-parse.js */ "./node_modules/langchain/dist/util/event-source-parse.js");
...
async function getResponse(request, config) {
    ...
    if (stageOne.status >= 200 && stageOne.status !== 204) {
        if (config.responseType === "stream") {
            ...
            if (!contentType?.startsWith(_event_source_parse_js__WEBPACK_IMPORTED_MODULE_1__.EventStreamContentType)) {
                throw new Error(`Expected content-type to be ${_event_source_parse_js__WEBPACK_IMPORTED_MODULE_1__.EventStreamContentType}, Actual: ${contentType}`);
            }
            await (0,_event_source_parse_js__WEBPACK_IMPORTED_MODULE_1__.getBytes)(stageOne.body, (0,_event_source_parse_js__WEBPACK_IMPORTED_MODULE_1__.getLines)((0,_event_source_parse_js__WEBPACK_IMPORTED_MODULE_1__.getMessages)(config.onmessage)));
        }
        else {
...
function createRequest(config) {
    ...
    // for streaming
    if (config.responseType === "stream") {
        options.headers.set("Accept", _event_source_parse_js__WEBPACK_IMPORTED_MODULE_1__.EventStreamContentType);
    }
...
function createError(message, config, code, request, response) {
    if (axios__WEBPACK_IMPORTED_MODULE_0__.AxiosError && typeof axios__WEBPACK_IMPORTED_MODULE_0__.AxiosError === "function") {
        return new axios__WEBPACK_IMPORTED_MODULE_0__.AxiosError(message, axios__WEBPACK_IMPORTED_MODULE_0__.AxiosError[code], config, request, response);
    }
...
//# sourceMappingURL=vendors-node_modules_langchain_dist_chat_models_openai_js.bundle.js.map